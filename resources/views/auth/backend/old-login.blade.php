...
<html lang="en">
    <head>
        ...
        <title>Laravel 12 Multi Auth | Admin</title>
                            ...
                            <div class="card-body p-3 p-md-4 p-xl-5">
                                ...
                                <form action="{{route('admin.authenticate')}}" method="post">
                                    ...
                                    <div class="row gy-3 overflow-hidden">
                                        ...
                                        <div class="col-12">
                                            <div class="form-floating mb-3">
                                                <input type="password" value="{{old('password')}}" class="form-control @error('password') is-invalid @enderror" class="form-control" name="password" id="password" value="" placeholder="Password">
