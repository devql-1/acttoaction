...
════════════════════════════════ --}}
        ...
        position:relative; min-height:340px; display:flex; align-items:center;">
                ...
                {{-- Decorative circles --}}
                <div
                    style="position:absolute;top:20px;right:8%;width:160px;height:160px;
                    border-radius:50%;border:1px solid rgba(255,255,255,0.08);
                    pointer-events:none;">
                </div>
                <div
                    style="position:absolute;bottom:20px;right:18%;width:70px;height:70px;
                ...
                <div class="container" style="position:relative;z-index:1;">
                    <div class="row justify-content-center text-center">
                        <div class="col-lg-8">
                            ...
                            @if ($test->description)
                                <p
                                    style="color:rgba(255,255,255,0.78);font-size:16px;
                    ...
                    <div class="col-xl-6 col-lg-7">
                        <div class="department-hero" data-aos="fade-right" data-aos-delay="200">
                            ...
                            <div class="badge-wrap">
                                <span class="specialty-badge">Cybersecurity Assessment</span>
                            </div>
                            ...
                            <p class="department-intro">
                                {{ $test->description
                                    ...
                                    : 'Discover your cybersecurity aptitude through this comprehensive, industry-informed assessment. Gain deep insight into your strengths, skill gaps, and the ideal Threat Expert course for your career path.' }}
                            </p>
                    ...
                    <div class="col-xl-6 col-lg-5">
                        <div class="department-visual" data-aos="fade-left" data-aos-delay="300">
                            <div class="image-container">
                                <img src="{{ asset('assets/img/health/neurology-2.webp') }}" alt="{{ $test->test_name }}"
                    ...
                    <div class="services-overview" data-aos="fade-up" data-aos-delay="400">
                        ...
                        <div class="row gy-4 services-grid">
                            @foreach ($categories as $ci => $category)
                                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="{{ 500 + $ci * 60 }}">
                                    <div class="service-item">
                                        ...
                                        @endif
                                        <p
                                            style="font-size:13px;color:var(--accent-color);
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-5" data-aos="fade-right" data-aos-delay="800">
                            <div class="expert-image">
                                <img src="{{ asset('assets/img/health/neurology-4.webp') }}" alt="{{ $test->test_name }}"
                                    class="img-fluid">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-7" data-aos="fade-left" data-aos-delay="800">
                            <div class="expert-content">
                                ...
                                <p class="lead">
                                    Gain clear insight into your cybersecurity strengths, skill gaps, and the ideal Threat
                                    Expert course for your career — through this industry-informed, practical assessment.
                                </p>

                                <div class="expertise-list">
                                    <div class="expertise-item">
                                        <i class="bi bi-check2"></i>
                                        <span>{{ $test->questions_count }} carefully crafted cybersecurity questions</span>
                                    </div>
                                    <div class="expertise-item">
                                        <i class="bi bi-check2"></i>
                                        <span>Covers {{ $test->categories_count }} distinct aptitude dimensions</span>
                                    </div>
                                    <div class="expertise-item">
                                        <i class="bi bi-check2"></i>
                                        <span>Instant results with detailed category breakdown and course
                                            recommendation</span>
                                    </div>
                                    <div class="expertise-item">
                                        <i class="bi bi-check2"></i>
