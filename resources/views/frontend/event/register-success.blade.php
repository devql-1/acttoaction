...
<style>
    ...
    .detail-row .dk i { color: var(--reg-blue); font-size: 13px; }
    .detail-row .dv {
        font-family: var(--reg-font-head);
        font-weight: 700;
        color: var(--reg-ink);
    ...
    .total-row .tv.free { color: var(--reg-green); }
    ...
    .btn-wa:hover { background: #1fba58; transform: translateY(-2px); color: #fff; }
    ...
    .btn-outline:hover { border-color: var(--reg-blue); color: var(--reg-blue); }
    ...
    <div class="container">
        <div class="success-card">
            ...
            <div class="success-body">
                <div style="font-family:var(--reg-font-head);font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:.8px;color:var(--reg-muted);margin-bottom:12px;">
                    Booking Details
                </div>
                ...
                <div class="detail-row">
                    ...
                    <span class="dv">{{ \Carbon\Carbon::parse($registration->subEvent->event_date)->format('M j, Y') }}</span>
                </div>
                <div class="detail-row">
            ...
            <div class="note-box">
                ...
                <div>Our team will reach out on <strong>+{{ $registration->phone }}</strong> via WhatsApp to confirm your booking. Please save our number.</div>
            </div>
