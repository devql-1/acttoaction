...
--}}
    ...
    <div class="pg">
        ...
        <div class="hero">
            @if ($sub->banner_image)
                <div
                    style="position:absolute;inset:0;background-image:url('{{ $sub->banner_url }}');background-size:cover;background-position:center;z-index:0;">
                </div>
                <div
                    ...
                    <div class="col-lg-5">
                        <div class="sidebar">
                            ...
                            <div class="sc">
                                ...
                                <div class="sc-help">
                                    <a href="https://wa.me/{{ $whatsappDigits }}" target="_blank" class="hw">
