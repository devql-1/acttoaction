...
a {
        ...
        .scroll-top {
            ...
            width: 44px; height: 44px; background: var(--accent-color); border-radius: 50%;
            display: flex; align-items: center; justify-content: center;
            color: #fff; font-size: 20px; opacity: 0; visibility: hidden;
            transition: all 0.4s cubic-bezier(.34, 1.56, .64, 1);
            box-shadow: 0 4px 18px rgba(23, 92, 221, 0.38);
        }
        .scroll-top.active { opacity: 1; visibility: visible; }
        .scroll-top:hover { background: color-mix(in srgb, var(--accent-color), #000 15%); color: #fff; transform: translateY(-3px); }
        ...
        .workshop-banner .wb-inner {
            ...
            gap: 24px; padding: 22px 0; flex-wrap: wrap;
        }
        .workshop-banner .wb-left { display: flex; align-items: center; gap: 18px; animation: fadeInLeft .6s ease both; }
        .workshop-banner .wb-icon {
            width: 52px; height: 52px; border-radius: 14px;
            background: rgba(255,255,255,.14); border: 1.5px solid rgba(255,255,255,.22);
            display: flex; align-items: center; justify-content: center;
            font-size: 22px; color: #ffd96a; flex-shrink: 0;
            backdrop-filter: blur(6px); animation: pulseRing 2.5s ease infinite;
        }
        .workshop-banner .wb-text .wb-label {
            display: inline-flex; align-items: center; gap: 6px;
            background: rgba(255,255,255,.12); border: 1px solid rgba(255,255,255,.2);
            color: #a8c4ff; font-size: 11px; font-weight: 700;
            padding: 3px 12px; border-radius: 20px; text-transform: uppercase;
            letter-spacing: 1px; margin-bottom: 6px;
        }
        .workshop-banner .wb-text h3 {
            font-size: 20px; font-weight: 800; color: #fff;
            margin: 0 0 3px; line-height: 1.25; font-family: var(--heading-font);
        }
        ...
        .workshop-banner .wb-text p { font-size: 13px; color: rgba(255,255,255,.68); margin: 0; line-height: 1.5; }
        ...
        .workshop-banner .wb-badge {
            ...
            border-radius: 10px; padding: 10px 16px; color: rgba(255,255,255,.85);
            font-size: 13px; font-weight: 600; backdrop-filter: blur(6px);
        }
        .workshop-banner .wb-badge i { color: #ffd96a; font-size: 15px; }
        .workshop-banner .btn-workshop {
            display: inline-flex; align-items: center; gap: 9px;
            background: #ffd96a; color: #0d1f4a; padding: 13px 28px;
            border-radius: 50px; font-weight: 800; font-size: 14px;
            transition: all .3s cubic-bezier(.34,1.56,.64,1);
            box-shadow: 0 5px 18px rgba(255,217,106,.4);
            white-space: nowrap; text-decoration: none;
        }
        .workshop-banner .btn-workshop:hover {
            background: #ffca28; color: #0d1f4a;
            transform: translateY(-3px) scale(1.03); box-shadow: 0 10px 28px rgba(255,217,106,.55); gap: 13px;
        }
        .workshop-banner .btn-workshop i { font-size: 13px; transition: transform .3s; }
        .workshop-banner .btn-workshop:hover i { transform: translateX(3px); }
        @media (max-width: 768px) {
            .workshop-banner .wb-inner { flex-direction: column; align-items: flex-start; gap: 16px; padding: 18px 0; }
            .workshop-banner .wb-right { width: 100%; justify-content: space-between; }
            .workshop-banner .wb-badge { display: none; }
            .workshop-banner .btn-workshop { width: 100%; justify-content: center; }
        }

        /* ===================== SECTIONS ===================== */
        .section { padding: 80px 0; }
        .section-alt { background-color: color-mix(in srgb, var(--accent-color), transparent 96%); }
        .section-title { text-align: center; padding-bottom: 50px; position: relative; }
        .section-title h2 { font-size: 36px; font-weight: 800; position: relative; padding-bottom: 20px; margin-bottom: 15px; }
        .section-title p { color: color-mix(in srgb, var(--default-color), transparent 25%); max-width: 680px; margin: 0 auto; font-size: 16px; line-height: 1.7; }

        /* ===================== WHY JOIN ===================== */
        .why-join .reason-card {
            background: #fff; border-radius: 20px; padding: 36px 28px;
            box-shadow: 0 5px 30px rgba(0,0,0,.06); transition: 0.35s; height: 100%;
        ...
        .why-join .reason-card:hover::before { transform: scaleX(1); }
        .why-join .reason-card:hover { transform: translateY(-8px); box-shadow: 0 20px 50px rgba(23,92,221,.13); }
        .why-join .reason-card .icon {
            width: 68px; height: 68px;
            background: color-mix(in srgb, var(--accent-color), transparent 90%);
            border-radius: 18px; display: flex; align-items: center; justify-content: center;
            font-size: 28px; color: var(--accent-color); margin-bottom: 22px; transition: 0.3s;
        }
        .why-join .reason-card:hover .icon { background: var(--accent-color); color: #fff; }
        .why-join .reason-card h4 { font-size: 18px; font-weight: 800; margin-bottom: 12px; }
        .why-join .reason-card p { font-size: 14px; line-height: 1.75; color: color-mix(in srgb, var(--default-color), transparent 15%); margin: 0; }

        /* ===================== ROLES ===================== */
        .roles .role-item {
            display: flex; align-items: flex-start; gap: 20px;
            background: #fff; border-radius: 16px; padding: 26px 24px;
            box-shadow: 0 3px 18px rgba(0,0,0,.06); transition: 0.3s; margin-bottom: 20px;
        }
        .roles .role-item:hover { transform: translateX(6px); box-shadow: 0 8px 30px rgba(23,92,221,.1); }
        .roles .role-item:last-child { margin-bottom: 0; }
        .roles .role-item .role-icon {
            width: 54px; height: 54px; flex-shrink: 0; background: var(--accent-color);
            border-radius: 14px; display: flex; align-items: center; justify-content: center;
            font-size: 22px; color: #fff;
        }
        .roles .role-item h5 { font-size: 16px; font-weight: 800; margin-bottom: 5px; }
        .roles .role-item p { font-size: 13px; color: color-mix(in srgb, var(--default-color), transparent 20%); margin: 0; line-height: 1.65; }
        .roles .role-item .badge-role {
            display: inline-block; background: color-mix(in srgb, var(--accent-color), transparent 88%);
            color: var(--accent-color); font-size: 11px; font-weight: 700;
            padding: 3px 10px; border-radius: 20px; margin-bottom: 6px;
            text-transform: uppercase; letter-spacing: 0.5px;
        }

        /* ===================== STEPS ===================== */
        .steps-section .step-card { text-align: center; padding: 10px 20px; position: relative; }
        .steps-section .step-card .step-num {
            width: 60px; height: 60px; background: var(--accent-color); border-radius: 50%;
            display: flex; align-items: center; justify-content: center;
            font-size: 22px; font-weight: 900; color: #fff; margin: 0 auto 18px;
            font-family: var(--heading-font);
            box-shadow: 0 6px 20px rgba(23,92,221,.35); position: relative; z-index: 1;
        }
        .steps-section .step-card h5 { font-size: 16px; font-weight: 800; margin-bottom: 8px; }
        .steps-section .step-card p { font-size: 13px; color: color-mix(in srgb, var(--default-color), transparent 20%); margin: 0; line-height: 1.6; }
        .steps-section .connector { flex: 1; height: 2px; background: color-mix(in srgb, var(--accent-color), transparent 70%); margin-top: -32px; position: relative; top: -35px; }

        /* ===================== SCHOOL PARTNERSHIP SLIDER ===================== */
        .school-partners { padding: 70px 0 80px; background: #f4f8ff; overflow: hidden; }
        .school-partners .section-title { padding-bottom: 40px; }
        .school-partners .section-title h2 { font-size: 34px; }
        .school-partners .section-title .partner-badge {
            display: inline-flex; align-items: center; gap: 7px;
            background: color-mix(in srgb, var(--accent-color), transparent 90%);
            color: var(--accent-color); font-size: 11px; font-weight: 800;
            padding: 5px 16px; border-radius: 6px; text-transform: uppercase;
        ...
        .partners-marquee-wrap::before { left: 0; background: linear-gradient(to right, #f4f8ff, transparent); }
        .partners-marquee-wrap::after  { right: 0; background: linear-gradient(to left, #f4f8ff, transparent); }
        .partners-marquee { display: flex; gap: 20px; animation: marquee 30s linear infinite; width: max-content; }
        .partners-marquee:hover { animation-play-state: paused; }
        .partner-logo-card {
            background: #fff; border: 1.5px solid #e0e8f5; border-radius: 16px; overflow: hidden;
            width: 200px; height: 130px; flex-shrink: 0;
            transition: border-color .25s, box-shadow .25s, transform .25s;
            cursor: default; position: relative;
        }
        .partner-logo-card:hover { border-color: var(--accent-color); box-shadow: 0 8px 26px rgba(23,92,221,.14); transform: translateY(-5px); }
        .partner-logo-card img { width: 100%; height: 100%; object-fit: cover; display: block; filter: grayscale(20%); transition: filter .3s, transform .4s; }
        .partner-logo-card:hover img { filter: grayscale(0%); transform: scale(1.05); }
        .partner-logo-card .ph-name {
            position: absolute; bottom: 0; left: 0; right: 0;
            background: linear-gradient(to top, rgba(13,31,74,.82), transparent);
            color: #fff; font-size: 11px; font-weight: 700; text-align: center;
            padding: 14px 8px 8px; line-height: 1.3; letter-spacing: .2px;
        }
        .partners-stats { display: flex; justify-content: center; gap: 48px; margin-top: 48px; flex-wrap: wrap; }
        .partners-stats .ps-item { text-align: center; }
        .partners-stats .ps-item .ps-num { font-size: 2.2rem; font-weight: 900; color: var(--accent-color); font-family: var(--heading-font); display: block; line-height: 1; }
        .partners-stats .ps-item .ps-lbl { font-size: 13px; color: color-mix(in srgb, var(--default-color), transparent 30%); margin-top: 5px; display: block; font-weight: 500; }

        /* ===================== PARTNER CATEGORY TABS ===================== */
        .partner-cat-tabs { display: flex; flex-wrap: wrap; gap: 10px; justify-content: center; margin: 18px 0 28px; }
        .pcat-btn {
            padding: 7px 22px; border-radius: 50px; border: 2px solid var(--accent-color);
            background: transparent; color: var(--accent-color); font-size: 14px; font-weight: 600;
            cursor: pointer; transition: background 0.25s, color 0.25s;
        }
        .pcat-btn:hover, .pcat-btn.active { background: var(--accent-color); color: #fff; }
                ...
                <div class="row gy-5 align-items-start">
                    <div class="col-lg-5" data-aos="fade-right">
                        ...
                        <div style="background:var(--accent-color);border-radius:16px;padding:22px 24px;color:#fff;">
                            <p style="font-size:13px;font-weight:700;text-transform:uppercase;letter-spacing:1px;opacity:0.8;margin-bottom:8px;">Currently Active In</p>
                            <p style="font-size:16px;font-weight:800;margin:0;color:#fff;">Jaipur, Rajasthan &amp; Online</p>
        ...
        <section class="steps-section section">
            <div class="container">
                ...
                <div class="row justify-content-center align-items-center gy-4" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="d-none d-lg-block col-lg-1"><div class="connector"></div></div>
                    <div class="col-lg-2 col-md-4 col-6">
                        <div class="step-card">
        ...
        <section class="school-partners" data-aos="fade-up">
                    ...
                    <div class="partners-marquee">
                        @foreach($allSchools as $school)
                            <div class="partner-logo-card">
                                <img src="{{ $school->logo_url }}" alt="{{ $school->name }}" loading="lazy" onerror="this.style.display='none'">
            ...
            <div class="container">
                <div class="partners-stats" data-aos="fade-up" data-aos-delay="150">
                    ...
                    <div class="ps-item"><span class="ps-num">1000+</span><span class="ps-lbl">Children Reached</span></div>
                    <div class="ps-item"><span class="ps-num">6+</span><span class="ps-lbl">Cities Active</span></div>
                    <div class="ps-item"><span class="ps-num">5★</span><span class="ps-lbl">Avg. School Rating</span></div>
                </div>
            </div>
        </section>
        ...
        (function () {
            ...
            btns.forEach(btn => {
                btn.addEventListener('click', function () {
                    ...
                    wraps.forEach(w => { w.style.display = (w.dataset.catWrap === cat) ? '' : 'none'; });
                });
            });
        })();
        </script>
        ...
        <section class="container">
            <div class="workshop-banner">
                <div class="container">
                    <div class="wb-inner">
                        <div class="wb-left">
                            <div class="wb-icon"><i class="bi bi-geo-alt-fill"></i></div>
                            <div class="wb-text">
                                <div class="wb-label"><i class="bi bi-lightning-charge-fill"></i> Now Live in Jaipur</div>
                        ...
                        <div class="wb-right">
                            ...
                            <a href="#" class="btn-workshop">Browse Workshops <i class="bi bi-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
