...
@section('content')
    <style>
        ...
        .thumb-navy {
            background: linear-gradient(135deg, #0e1c38 0%, #2d4a7a 100%);
        }
    ...
    <main class="main merch-wrap">
        ...
        <section class="merch-hero">
            <div class="container">
                ...
                <h1>Gear Up With <span>Threat&nbsp;Expert</span></h1>
                <p>Rep the community. Premium apparel, accessories, and essentials designed for cybersecurity professionals
                    and digital defenders.</p>
            </div>
        </section>
            ...
            <div class="merch-grid" id="merchGrid">
                ...
                <div class="merch-card" data-cat="apparel">
                    ...
                    <div class="merch-card-body">
                        ...
                        <p class="merch-card-desc">100% premium cotton, pre-shrunk tee with embroidered Threat Expert logo
                            on the chest.</p>
                ...
                <div class="merch-card" data-cat="apparel">
                    ...
                    <div class="merch-card-body">
                        ...
                        <p class="merch-card-desc">Heavyweight fleece-lined hoodie with front pouch pocket, drawstring hood,
                            and Threat Expert branding.</p>
                        <div class="merch-card-foot">
                ...
                <div class="merch-card" data-cat="accessories">
                    ...
                    <div class="merch-card-body">
                        ...
                        <h3 class="merch-card-title">Cyber Dad Cap</h3>
                        <p class="merch-card-desc">Adjustable cotton cap with embroidered Threat Expert monogram. One size
                            fits most.</p>
                        <div class="merch-card-foot">
                ...
                <div class="merch-card" data-cat="accessories">
                    ...
                    <div class="merch-card-body">
                        ...
                        <p class="merch-card-desc">Double-wall stainless steel, 750ml capacity. Keeps drinks cold for 24
                            hrs. Threat Expert branded.</p>
                        <div class="merch-card-foot">
                ...
                <div class="merch-card" data-cat="stationery">
                    ...
                    <div class="merch-card-body">
                        ...
                        <h3 class="merch-card-title">Hacker's Notebook</h3>
                        <p class="merch-card-desc">A5 hardcover notebook with 200 pages of dotted premium paper, ribbon
                            marker. Perfect for labs and notes.</p>
                        <div class="merch-card-foot">
                ...
                <div class="merch-card" data-cat="accessories">
                    ...
                    <div class="merch-card-body">
                        ...
                        <p class="merch-card-desc">Heavy-duty 12oz canvas, reinforced straps, Threat Expert print. Perfect
                            for daily carry to training.</p>
                        <div class="merch-card-foot">
                ...
                <div class="merch-card" data-cat="stationery">
                    ...
                    <div class="merch-card-body">
                        <div class="merch-card-cat">Stationery</div>
                        <h3 class="merch-card-title">Cyber Sticker Pack (12pcs)</h3>
                        <p class="merch-card-desc">Waterproof vinyl stickers with security-themed designs. Stick them on
                            laptops, bottles, notebooks — anywhere.</p>
                        <div class="merch-card-foot">
                ...
                <div class="merch-card" data-cat="limited">
                    ...
                    <div class="merch-card-body">
                        ...
                        <h3 class="merch-card-title">Threat Expert Ceramic Mug</h3>
                        <p class="merch-card-desc">Matte-finish 350ml ceramic mug, commemorative edition with Threat Expert
                            branding. Only 200 made.</p>
                        <div class="merch-card-foot">
        ...
        <section class="merch-cta">
            <div class="merch-cta-inner">
                <h2>Join the Threat Expert Crew</h2>
                <p>Be the first to know about new drops, limited editions, and member-only discounts for our cybersecurity
                    community.</p>
