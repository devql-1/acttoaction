...
<main class="main">
    ...
    <div class="stepper-wrap">
        <div class="stepper">
            ...
            <div class="step-item active" id="si-0"><div class="step-circle">1</div><div class="step-label">Personal</div></div>
            <div class="step-item" id="si-1"><div class="step-circle">2</div><div class="step-label">Parents</div></div>
            <div class="step-item" id="si-2"><div class="step-circle">3</div><div class="step-label">Contact</div></div>
            <div class="step-item" id="si-3"><div class="step-circle">4</div><div class="step-label">Location</div></div>
            <div class="step-item" id="si-4"><div class="step-circle">5</div><div class="step-label">Course</div></div>
            <div class="step-item" id="si-5"><div class="step-circle">6</div><div class="step-label">Confirm</div></div>
        </div>
    </div>
        ...
        <div class="form-panel">
            ...
            <div class="step-content active" data-step="0">
                <div class="panel-head">
                    <div class="ph-icon" style="background:#eff6ff;color:var(--blue);"><i class="bi bi-person-fill" style="font-size:22px;"></i></div>
                    <div>
                ...
                <div class="panel-body">
                    <div class="row-2">
                        <div class="field-group">
                            ...
                            <input class="fi" type="text" id="firstName" placeholder="e.g. Aryan" autocomplete="given-name" />
                            <div class="field-error" id="err-firstName"><i class="bi bi-exclamation-circle"></i> First name is required</div>
                        </div>
                        <div class="field-group">
                            <label>Last Name <span class="req">*</span></label>
                            <input class="fi" type="text" id="lastName" placeholder="e.g. Sharma" autocomplete="family-name" />
                    ...
                    <div class="row-2">
                        ...
                        <div class="field-group">
                            ...
                            <input class="fi" type="text" id="ageDisplay" placeholder="Will auto-fill" readonly
                                style="background:#f5f7fc;color:var(--muted);cursor:default;" />
                        </div>
                    </div>
                    <div class="field-group">
                        <label>Gender <span class="req">*</span></label>
                        <div class="radio-group">
                            <div class="radio-card"><input type="radio" name="gender" id="g-male" value="Male" /><label class="radio-label" for="g-male"><span class="radio-dot"></span> Male</label></div>
                            <div class="radio-card"><input type="radio" name="gender" id="g-female" value="Female" /><label class="radio-label" for="g-female"><span class="radio-dot"></span> Female</label></div>
                            <div class="radio-card"><input type="radio" name="gender" id="g-other" value="Other" /><label class="radio-label" for="g-other"><span class="radio-dot"></span> Other</label></div>
                        </div>
            ...
            <div class="step-content" data-step="1">
                <div class="panel-head">
                    <div class="ph-icon" style="background:#fdf2f8;color:#db2777;"><i class="bi bi-people-fill" style="font-size:22px;"></i></div>
                    <div>
                ...
                <div class="panel-body">
                    <div class="row-2">
                        <div class="field-group">
                            ...
                            <div class="field-error" id="err-fatherName"><i class="bi bi-exclamation-circle"></i> Father's name is required</div>
                        </div>
                        <div class="field-group">
                            <label>Mother's Name <span class="req">*</span></label>
                            <input class="fi" type="text" id="motherName" placeholder="e.g. Priya Sharma" />
                            <div class="field-error" id="err-motherName"><i class="bi bi-exclamation-circle"></i> Mother's name is required</div>
                        </div>
                    </div>
                    <div class="row-2">
                        <div class="field-group">
                            <label>Parent Phone <span class="opt">(optional)</span></label>
                            <input class="fi" type="tel" id="parentPhone" placeholder="e.g. 98765 43210" maxlength="15" />
                            <div class="field-hint">We'll send updates via WhatsApp</div>
                        </div>
                        <div class="field-group">
                            <label>Parent Email <span class="opt">(optional)</span></label>
                            <input class="fi" type="email" id="parentEmail" placeholder="e.g. rajesh@email.com" />
                        </div>
                    </div>
                </div>
                <div class="panel-footer">
            ...
            <div class="step-content" data-step="2">
                <div class="panel-head">
                    <div class="ph-icon" style="background:#ecfdf5;color:#059669;"><i class="bi bi-telephone-fill" style="font-size:22px;"></i></div>
                    <div>
                ...
                <div class="panel-body">
                    ...
                    <div class="row-2">
                        <div class="field-group">
                            ...
                            <input class="fi" type="tel" id="phone" placeholder="e.g. 93520 23276" maxlength="15" />
                        ...
                        <div class="field-group">
                            ...
                            <input class="fi" type="email" id="email" placeholder="e.g. aryan@email.com" />
                    ...
                    <div class="row-2">
                        <div class="field-group">
                            ...
                            <input class="fi" type="text" id="school" placeholder="e.g. Mayoor School, Jaipur" />
                            <div class="field-error" id="err-school"><i class="bi bi-exclamation-circle"></i> School name is required</div>
                        </div>
                        <div class="field-group">
                            ...
                            <div class="field-error" id="err-grade"><i class="bi bi-exclamation-circle"></i> Please select a class</div>
                        </div>
                    </div>
                    <div class="field-group">
                        <label>Achievements / Additional Notes <span class="opt">(optional)</span></label>
                        <textarea class="fi" id="achievements" placeholder="Any prior acting experience, awards, special skills…" style="min-height:90px;"></textarea>
                    </div>
                </div>
                <div class="panel-footer">
            ...
            <div class="step-content" data-step="3">
                <div class="panel-head">
                    <div class="ph-icon" style="background:#fff7ed;color:#d97706;"><i class="bi bi-geo-alt-fill" style="font-size:22px;"></i></div>
                    <div>
                        ...
                        <p class="ph-sub">
                            ...
                            in
                            <strong>{{ count($courseStates ?? []) }} {{ Str::plural('state', count($courseStates ?? [])) }}</strong>.
                        </p>
                    </div>
                </div>
                <div class="panel-body">
                    <div class="row-2">
                        <div class="field-group">
                            ...
                            <div class="field-error" id="err-state"><i class="bi bi-exclamation-circle"></i> Please select your state</div>
                        </div>
                        <div class="field-group">
                    ...
                    <div id="centre-info-wrap" style="display:none;margin-top:8px;">
                        <div style="background:#f0f5ff;border:1.5px solid #dbeafe;border-radius:14px;padding:18px 20px;">
                            <div style="display:flex;gap:14px;align-items:flex-start;">
                                ...
                                <div style="flex:1;">
                                    ...
                                    <div style="display:flex;flex-wrap:wrap;gap:12px;align-items:center;">
                                        ...
                                        <span id="ci-email-wrap" style="display:none;align-items:center;gap:4px;font-size:12px;color:#175cdd;font-weight:600;">
                ...
                <div class="panel-footer">
                    ...
                    <div style="display:flex;align-items:center;gap:16px;">
                        ...
                        <button class="btn-next" onclick="nextStep(3)">Continue <i class="bi bi-arrow-right"></i></button>
                    </div>
                </div>
            </div>
            ...
            <div class="step-content" data-step="4">
                <div class="panel-head">
                    <div class="ph-icon" style="background:#f5f3ff;color:#7c3aed;"><i class="bi bi-mortarboard-fill" style="font-size:22px;"></i></div>
                    <div>
                ...
                <div class="panel-body">
                    ...
                    <div style="background:linear-gradient(135deg,#eff6ff,#f5f3ff);border:2px solid #bfdbfe;border-radius:18px;padding:22px 24px;margin-bottom:24px;position:relative;overflow:hidden;">
                        {{-- Badge --}}
                        <div style="position:absolute;top:16px;right:16px;background:#175cdd;color:#fff;font-size:11px;font-weight:800;padding:5px 14px;border-radius:20px;letter-spacing:.5px;">
                            ✓ SELECTED
                        </div>
                        <div style="display:flex;gap:18px;align-items:flex-start;flex-wrap:wrap;">
                            ...
                            <div style="flex:1;min-width:180px;">
                                ...
                                @if($course->category)
                                    <div style="font-size:12px;font-weight:700;color:#7c3aed;margin-bottom:12px;text-transform:uppercase;letter-spacing:.4px;">
                                        {{ $course->category->name }}
                                    </div>
                                @endif
                                <div style="display:flex;flex-wrap:wrap;gap:8px;margin-bottom:10px;">
                                    @if($course->age_group)
                                        <span style="background:#eff6ff;color:#175cdd;font-size:12px;font-weight:600;padding:4px 10px;border-radius:20px;">
                                    ...
                                    @if($course->sessions)
                                        <span style="background:#ecfdf5;color:#059669;font-size:12px;font-weight:600;padding:4px 10px;border-radius:20px;">
                                            <i class="bi bi-calendar-check-fill me-1"></i>{{ $course->sessions }} Sessions
                                        </span>
                                    @endif
                            ...
                            {{-- Fee --}}
                            @if($course->fees)
                                <div style="text-align:center;min-width:110px;background:#fff;border-radius:14px;padding:14px 16px;box-shadow:0 2px 12px rgba(23,92,221,.08);">
                        ...
                        <input type="radio" name="course" id="c-main" value="{{ $course->title }}" checked style="display:none;" />
                    </div>
                    ...
                    <div style="background:#f0f5ff;border:1.5px solid #dbeafe;border-radius:14px;padding:16px 20px;display:flex;align-items:center;gap:14px;margin-bottom:20px;">
                    ...
                    <div class="field-group">
                        ...
                        <div class="coupon-row">
                            <input class="fi" type="text" id="coupon" placeholder="e.g. WELCOME20" style="text-transform:uppercase;" />
                ...
                <div class="panel-footer">
                    ...
                    <div style="display:flex;align-items:center;gap:16px;">
                        ...
                        <button class="btn-next" onclick="nextStep(4)">Review &amp; Confirm <i class="bi bi-arrow-right"></i></button>
                    </div>
                </div>
            </div>
            ...
            <div class="step-content" data-step="5">
                <div class="panel-head">
                    <div class="ph-icon" style="background:#ecfdf5;color:#059669;"><i class="bi bi-clipboard2-check-fill" style="font-size:22px;"></i></div>
                    <div>
                    ...
                    <div style="display:flex;flex-direction:column;gap:12px;margin-bottom:8px;">
                        <label class="check-card" id="chk-terms-card" onclick="toggleCheck('terms')">
                            ...
                            <div class="check-text">
                                ...
                                <span>I have read and accept the
                                    <a href="https://www.acttoaction.com/terms-and-conditions" target="_blank" style="color:var(--blue);font-weight:600;" onclick="event.stopPropagation()">Terms &amp; Conditions</a>
                                    and
                                    <a href="https://www.acttoaction.com/refund-policy" target="_blank" style="color:var(--blue);font-weight:600;" onclick="event.stopPropagation()">Refund Policy</a>.
                                </span>
                            </div>
                        </label>
                        <label class="check-card" id="chk-newsletter-card" onclick="toggleCheck('newsletter')">
                            ...
                            <div class="check-text">
                                ...
                                <span>Receive news about upcoming events, summer camps, casting calls, and courses.</span>
                            </div>
                        </label>
                    </div>
                    <div class="field-error" id="err-terms">
                        <i class="bi bi-exclamation-circle"></i> You must agree to the Terms &amp; Conditions to continue
                    </div>
                </div>
                <div class="panel-footer">
...
<script>
    ...
    function validateStep(step) {
        var ok = true;
        function req(id, cond) { showErr(id, !cond); if (!cond) ok = false; }
        ...
        if (step === 0) {
            ...
            var dobOk  = false;
            if (dobVal) {
                var d = new Date(dobVal); var now = new Date();
    ...
    function buildSummary() {
        ...
        for (var i = 0; i < items.length; i++) {
            ...
            div.innerHTML =
                '<div style="font-size:11px;font-weight:600;color:var(--muted);text-transform:uppercase;letter-spacing:.4px;margin-bottom:2px;">' + items[i][0] + '</div>'
    ...
    function submitForm() {
        ...
        .then(function(data) {
            ...
            document.getElementById('miniBar').style.width = '100%';
            for (var i = 0; i < TOTAL_STEPS; i++) {
                var si = document.getElementById('si-' + i);
                si.className = 'step-item done';
                si.querySelector('.step-circle').textContent = '\u2713';
            }
