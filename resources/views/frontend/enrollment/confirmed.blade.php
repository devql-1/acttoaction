...
.confirmed-wrap {
    ...
    .confirmed-title { font-size: 26px; font-weight: 800; color: #0e1c35; margin-bottom: 8px; }
    .confirmed-sub   { font-size: 15px; color: #6b7a99; margin-bottom: 28px; }
    .ref-box {
        background: #f0fdf4; border: 1.5px solid #86efac;
        border-radius: 12px; padding: 16px 20px; margin-bottom: 28px;
    }
    .ref-label { font-size: 11px; font-weight: 700; color: #166534; text-transform: uppercase; letter-spacing: .5px; }
    .ref-value { font-size: 22px; font-weight: 800; color: #16a34a; letter-spacing: 1px; margin-top: 4px; }
    .detail-grid { text-align: left; margin-bottom: 28px; }
    .detail-row  { display: flex; justify-content: space-between; padding: 8px 0; border-bottom: 1px solid #dde5f4; font-size: 14px; }
...
<div class="confirmed-wrap">
    <div class="confirmed-card">
        ...
        <div class="confirmed-sub">Your payment was successful. We'll be in touch soon.</div>
