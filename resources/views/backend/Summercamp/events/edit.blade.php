        ...
        <div class="page-inner">
            <div class="page-header">
                ...
                <ul class="breadcrumbs mb-3">
                    ...
                    <li class="separator"><i class="icon-arrow-right"></i></li>
                    <li class="nav-item"><a href="{{ route('summer-events.index', $event->id) }}">{{ $event->title }}</a>
                    </li>
                    <li class="separator"><i class="icon-arrow-right"></i></li>
            ...
            <div class="row">
                <div class="col-md-9 mx-auto">
                    <div class="card">
                        ...
                        <form action="{{ route('summer-events.update', $event->id) }}" method="POST"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <textarea name="description" id="descriptionEditor" class="form-control">{{ old('description', $event->description) }}</textarea>
                                    </div>
                                </div>
                            ...
                            <div class="card-action d-flex justify-content-between align-items-center">
                                <a href="{{ route('summer-events.index') }}" class="btn btn-secondary">
