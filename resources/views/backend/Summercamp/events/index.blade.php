                        ...
                        <div class="card-header">
                            <div class="card-head-row card-tools-still-right">
                                ...
                                <div class="card-tools">
                                    <a href="{{ route('summer-events.create') }}" class="btn btn-success btn-sm">
                    ...
                    transition:transform 0.3s;">
                                                ...
                                                <td class="text-center">
                                                    <label class="switch">
                                                        <input type="checkbox" class="toggle-status"
                                                            data-id="{{ $event->id }}"
                                                            data-url="{{ route('summer-events.status') }}"
                                                ...
                                                <td class="text-center">
                                                    <div
                                                        ...
                                                        {{-- Sub Events --}}
                                                        <a href="{{ route('summer-sub-events.index', $event->id) }}"
                                                        ...
                                                        {{-- Edit --}}
                                                        <a href="{{ route('summer-events.edit', $event->id) }}"
                                                        ...
                                                        <form id="delete-form-{{ $event->id }}"
                                                            action="{{ route('summer-events.destroy', $event->id) }}"
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="7" class="text-center text-muted py-4">
                                                    No events found.
                                                    <a href="{{ route('summer-events.create') }}">Create your first
                                                        event</a>
                                                </td>
                                            </tr>
                                        @endforelse
