...
@section('content')
    <div class="container">
        <div class="page-inner">
            ...
            <input type="hidden" name="type" value="summer-event">
            <div class="row">
                <div class="col-md-9 mx-auto">
                    <div class="card">
                        ...
                        <form action="{{ route('summer-events.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <textarea name="description" id="descriptionEditor" class="form-control">{{ old('description') }}</textarea>
                                    </div>
                                </div>
