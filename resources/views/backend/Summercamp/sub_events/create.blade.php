    ...
    <div class="container">
        <div class="page-inner">
            ...
            <div class="alert alert-light border mb-4 d-flex align-items-center gap-3">
                <img src="{{ $event->banner_url }}" class="rounded"
            ...
            <div class="row">
                <div class="col-md-10 mx-auto">
                    <div class="card">
                        ...
                        <form action="{{ route('summer-sub-events.store', $event->id) }}" method="POST"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <textarea name="description" id="descriptionEditor" class="form-control" rows="3">{{ old('description') }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="number" name="fees" class="form-control"
                                            value="{{ old('fees', 0) }}" min="0" placeholder="0 for free">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <select name="mode" class="form-control">
                                            <option value="offline" {{ old('mode') == 'offline' ? 'selected' : '' }}>
                                                Offline
                                            </option>
                                            <option value="online" {{ old('mode') == 'online' ? 'selected' : '' }}>Online
                                            </option>
                                            <option value="both" {{ old('mode') == 'both' ? 'selected' : '' }}>Both
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="number" name="max_seats" class="form-control"
                                            placeholder="Leave empty for unlimited" value="{{ old('max_seats') }}"
                                            min="1">
                                    </div>
                                </div>
                            ...
                            <div class="card-action d-flex justify-content-between align-items-center">
                                <a href="{{ route('summer-events.index', $event->id) }}" class="btn btn-secondary">
    ...
    <script>
        ...
        function loadCenters(selectEl, rowId) {
            ...
            fetch(`{{ route('centers-by-state') }}?state_id=${stateId}`)
                ...
                .catch(() => {
                    container.innerHTML =
                        '<small class="text-danger"><i class="fa fa-times-circle me-1"></i> Failed to load centers. Try again.</small>';
                });
        }
    </script>
@endsection
