        ...
        <div class="page-inner">
            <div class="page-header">
                ...
                <ul class="breadcrumbs mb-3">
                    ...
                    <li class="nav-item"><a href="{{ route('summer-events.index') }}">Events</a></li>
                    <li class="separator"><i class="icon-arrow-right"></i></li>
            ...
            <div class="card card-round mb-4">
                <div class="card-body py-3">
                    <div class="row align-items-center">
                        <div class="col-auto">
                            <img src="{{ asset('public/' . $event->banner_image) }}" alt="{{ $event->title }}" class="rounded"
                        ...
                        <div class="col">
                            ...
                            @if ($event->instagram_link)
                                <a href="{{ $event->instagram_link }}" target="_blank" class="ms-3 text-danger"
                                    style="font-size:12px;">
                                    <i class="fa fa-instagram"></i> Instagram
                                </a>
                            @endif
                            @if ($event->highlights_link)
                                <a href="{{ $event->highlights_link }}" target="_blank" class="ms-2 text-primary"
                                    style="font-size:12px;">
                        ...
                        <div class="col-auto d-flex gap-2">
                            <a href="{{ route('summer-sub-events.create', $event->id) }}" class="btn btn-success btn-sm">
                                <i class="fa fa-plus me-1"></i> Add Sub Event
                            </a>
                            <a href="{{ route('summer-sub-events.edit', $event->id) }}" class="btn btn-primary btn-sm">
                                <i class="fa fa-edit me-1"></i> Edit Event
                            </a>
                            <a href="{{ route('summer-events.index', $event->id) }}" class="btn btn-secondary btn-sm">
                        ...
                        <div class="card-header">
                            <div class="card-head-row card-tools-still-right">
                                ...
                                <div class="card-tools">
                                    <a href="{{ route('summer-sub-events.create', $event->id) }}"
                                            ...
                                            <tr id="record-row-{{ $subEvent->id }}">
                                                ...
                                                <td class="text-center">
                                                    <label class="switch">
                                                        <input type="checkbox" class="toggle-status"
                                                            data-id="{{ $subEvent->id }}"
                                                            data-url="{{ route('summer-sub-events.status') }}"
                                                ...
                                                <td class="text-center">
                                                    <div class="d-flex justify-content-center gap-1">
                                                        ...
                                                        <a href="{{ route('summer-sub-events.edit', $subEvent->id) }}"
                                                            class="btn btn-primary btn-sm">
                                                            <i class="fa fa-edit me-1"></i> Edit
                                                        </a>

                                                        <form id="delete-sub-{{ $subEvent->id }}"
                                                            action="{{ route('summer-sub-events.destroy', $subEvent->id) }}"
