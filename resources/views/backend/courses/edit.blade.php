                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="duration"
                                            ...
                                            placeholder="e.g. 1 Month" value="{{ old('duration', $course->duration) }}"
                                            required>
                                        @error('duration')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="number" name="total_sessions" class="form-control"
                                            value="{{ old('total_sessions', $course->sessions) }}" min="1">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="url" name="instagram_link" class="form-control"
                                            ...
                                            value="{{ old('instagram_link', $course->instagram_link) }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="url" name="highlights_link" class="form-control"
                                            ...
                                            value="{{ old('highlights_link', $course->highlights_link) }}">
                                    </div>
                                </div>
