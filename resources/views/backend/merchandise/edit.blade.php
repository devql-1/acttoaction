...
<div class="container">
    <div class="page-inner">
        <div class="page-header">
            <h3 class="fw-bold mb-3">Edit Merchandise Item</h3>
            ...
            <div class="col-md-8">
                <div class="card card-round">
                    <div class="card-header">
                        <div class="card-title">Edit: {{ $merchandise->name }}</div>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('merchandise.update', $merchandise->id) }}" method="POST"
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="description" rows="3" class="form-control"
                                    placeholder="Brief description of the item...">{{ old('description', $merchandise->description) }}</textarea>
                            </div>

                            {{-- Price --}}
                            <div class="mb-3">
                                <label class="form-label fw-semibold">Price (₹) <span class="text-danger">*</span></label>
                                <input type="number" name="price" value="{{ old('price', $merchandise->price) }}"
                            ...
                            <div class="mb-3">
                                <label class="form-label fw-semibold">
                                    {{ $merchandise->image_url ? 'Replace Photo' : 'Photo' }}
                                ...
                                <div class="form-text text-muted">JPG, PNG, WEBP — max 3MB. Leave blank to keep current.</div>
                                @error('image')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="row g-3 mb-4">
                                <div class="col-md-4">
                                    ...
                                    <input type="number" name="sort_order"
                                        value="{{ old('sort_order', $merchandise->sort_order) }}"
                                ...
                                <div class="col-md-8 d-flex align-items-end pb-1">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" name="status"
                                            id="status" value="1"
                                            {{ old('status', $merchandise->status) ? 'checked' : '' }}>
                            ...
                            <div class="d-flex gap-2">
                                <button type="submit" class="btn btn-success">
                                    <i class="fa fa-save me-1"></i> Update Item
                                </button>
