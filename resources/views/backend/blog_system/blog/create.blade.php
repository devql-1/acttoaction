                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="title" id="title2"
                                                    onkeyup="makeSlug(this.value)" value="{{ old('title') }}"
                                                    class="form-control @error('title') is-invalid @enderror"
                                                    placeholder="Enter Title">
                                                @error('title')
                                                    <p class="invalid-feedback">{{ $message }}</p>
                                                @enderror
                                                <small class="form-text text-muted">This title is your blogs
                                                    heading.</small>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <small class="form-text text-muted">
                                                    ...
                                                    <a href="{{ route('admin.blog-author.create') }}" target="_blank">+
                                                        Create new author</a>
                                                </small>
                           ...
                           p-3 border rounded d-flex align-items-center gap-3"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <small class="form-text text-muted">This image shows in your blogs image
                                                    section.</small>
                                            </div>
                                        </div>
