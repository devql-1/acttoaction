        ...
        <div class="page-inner">
            <div class="page-header">
                ...
                <ul class="breadcrumbs mb-3">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.testimonial-video-index') }}">Testimonial Videos</a>
                    </li>
                    <li class="separator"><i class="icon-arrow-right"></i></li>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="card card-round">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.testimonial-video-store') }}" method="POST" id="videoForm">
                                @csrf
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="channel_name" class="form-control"
                                                value="{{ old('channel_name', 'Threat Expert') }}" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    <a href="{{ route('admin.testimonial-video-index') }}" class="btn btn-secondary">
