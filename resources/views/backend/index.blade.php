        ...
        <div class="page-inner">
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                <div>
                    ...
                    <h6 class="op-7 mb-2">Admin Panel for You</h6>
                </div>
                    ...
                    <div class="card card-round">
                        <div class="card-header">
                            <div class="card-head-row card-tools-still-right">
                                ...
                                <div class="card-tools">
                                    <a href="#" class="btn btn-sm btn-primary btn-round">
                                    ...
                                    <tbody>
                                        @forelse ($recentPayments as $payment)
                                            <tr>
                                                ...
                                                <td>
                                                    <code
                                                        style="font-size:11px;">{{ $payment->razorpay_payment_id }}</code>
                                                </td>
                                                <td class="text-end" style="font-size:12px;white-space:nowrap;">
                                                    {{ $payment->paid_at ? $payment->paid_at->format('d M Y, g:ia') : '—' }}
                                                </td>
                                                ...
                                                <td class="text-end">
                                                    ...
                                                    @else
                                                        <span
                                                            class="badge badge-secondary">{{ ucfirst($payment->status) }}</span>
                                                    @endif
                                                </td>
                                            </tr>
                                        @empty
