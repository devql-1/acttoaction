              ...
              <div class="row">
                <div class="col-md-12 col-lg-12">
                  ...
                  <div class="form-group row">
                              ...
                              <div class="col-md-9">
                                  ...
                                  <x-multi-file-upload name="images[]" label="Upload Multiple Images" 
                                      :current="$service->multiple_images ? json_decode($service->multiple_images, true) : []" />
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-9">
                      <textarea id="advantages" class="form-control" name="advantages" rows="4" placeholder="Enter advantages, each point separated by a new line">{{ $service->advantages }}</textarea>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-9">
                      <textarea id="eligibility" class="form-control" name="eligibility" rows="4" placeholder="Enter eligibility points, each on a new line">{{ $service->eligibility }}</textarea>
                      <small class="form-text text-muted">Add one point per line.</small>
                    </div>
                  </div>
