{{-- resources/views/backend/blog_system/author/edit.blade.php --}}
...
<div class="container">
  <div class="page-inner">
    <div class="page-header">
      <h3 class="fw-bold mb-3">Edit Author</h3>
      ...
      <div class="col-md-8 mx-auto">
        <div class="card">
          <div class="card-header">
            <div class="card-title">Edit: {{ $author->name }}</div>
          </div>

          <form action="{{ route('admin.blog-author.update', $author->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-9">
                  <input type="text" name="designation" value="{{ old('designation', $author->designation) }}"
                         class="form-control" placeholder="e.g. Senior Writer">
                </div>
              </div>
                ...
                <div class="col-md-9">
                  @if($author->image)
                    <div class="d-flex align-items-center gap-3 mb-2">
                      <img src="{{ asset('img/authors/'.$author->image) }}"
                      ...
                      <div class="form-check">
                        ...
                        <label class="form-check-label text-danger" for="removeImage">Remove photo</label>
                      </div>
                    </div>
                  @endif
                  <x-file-upload name="image" label="Upload New Photo" />
              ...
              <div class="form-group row">
                ...
                <div class="col-md-9">
                  <input type="url" name="instagram" value="{{ old('instagram', $author->instagram) }}"
              ...
              <div class="form-group row">
                ...
                <div class="col-md-9">
                  <input type="url" name="facebook" value="{{ old('facebook', $author->facebook) }}"
              ...
              <div class="form-group row">
                ...
                <div class="col-md-9">
                  <input type="url" name="twitter" value="{{ old('twitter', $author->twitter) }}"
              ...
              <div class="form-group row">
                ...
                <div class="col-md-9">
                  <input type="url" name="linkedin" value="{{ old('linkedin', $author->linkedin) }}"
