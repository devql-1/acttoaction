                ...
                <div class="card card-round">
                    <div class="card-header">
                        <div class="card-head-row card-tools-still-right">
                            ...
                            <a href="{{route('admin.blog-create')}}" class="btn btn-dark ms-auto"><i class="fa fa-plus"></i> Add Blogs</a>
                            <!-- <button
                            ...
                            <table class="table align-items-center mb-0" id="basic-datatables">
                                ...
                                <tbody>
                                    ...
                                    <tr id="record-row-{{ $blog->id }}">
                                        ...
                                        <td class="text-end">{{ $blog->short_description ? $blog->short_description : '--' }}</td>
